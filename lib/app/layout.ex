defmodule Dialup.App.Layout do
  ...
  def render(assigns) do
    ...
    <footer class="site-footer">
      <p>
        This site was built with Dialup.
        Full docs on <a href="https://hexdocs.pm/dialup" target="_blank" rel="noopener">HexDocs</a>.
        Repository is <a href="https://github.com/SouichiroTsujimoto/dialup_site">here</a>.
      </p>
    </footer>
    """
  end
